...
function registerUser(name, email, password) {
  ...
  const endpoint = 'https://v-care-groups-backend-41436rrho-zodiac3k.vercel.app/register';
          ...
          <div className="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-[#4FA097] ">Your email</label>
                  <input type="email" id="signUpEmail" onChange={(e)=>{setUserEmail(e.target.value)}} name="email" className="bg-gray-50 border border-gray-300 text-[#4FA097] sm:text-sm rounded-lg focus:ring-[#4FA097] block w-full p-2.5 " placeholder="name@company.com" required="" />
                </div>
                <div>
                  <label htmlFor="password" className="block mb-2 text-sm font-medium text-[#4FA097] ">Password</label>
                  <input type="password" id="signUpPassword" onChange={(e)=>{setUserPassword(e.target.value)}}  name="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-[#4FA097] sm:text-sm rounded-lg focus:ring-[#4FA097] block w-full p-2.5 " required="" />
                </div>
                ...
                <p className="text-sm font-light text-gray-500 ">
                  Don’t have an account yet? <a onClick={toggleSignup} className="font-medium text-primary-600 hover:underline hover:cursor-pointer">Sign up</a>
                </p>
              </form>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
          ...
          <div className="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
              <div>
                  <label htmlFor="name" className="block mb-2 text-sm font-medium text-[#4FA097] ">Your Name</label>
                ...
                <p className="text-sm font-light text-gray-500 ">
                  Already have a account? <a onClick={toggleSignup} className="font-medium text-primary-600 hover:underline hover:cursor-pointer">Log in</a>
                </p>
              </form>
            </div>
          </div>
